    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="mt-1 text-slate-500">{labels?.length ?? 0} labels total</p>
        </div>
        <Link
      ...
      {!labels || labels.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-slate-200 py-20 text-center">
          <p className="text-slate-400 mb-3">No labels yet.</p>
          <Link
            href="/admin/labels/new"
        ...
        <div className="rounded-xl border border-slate-200 bg-white overflow-hidden shadow-sm">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-slate-100">
              {labels.map((label) => (
                <tr key={label.id} className="hover:bg-slate-50 transition-colors">
