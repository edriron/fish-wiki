    ...
    <div>
      <div className="mb-6">
        ...
        <div className="flex items-start justify-between">
          <div>
            <h1 className="text-2xl font-bold text-slate-900">{fish.common_name}</h1>
            <p className="mt-1 text-slate-500 italic text-sm">{fish.scientific_name}</p>
          </div>
          <FishDeleteButton
            fishId={fish.id}
      ...
      {/* Images section */}
      <section className="mt-10 rounded-xl border border-slate-200 bg-white overflow-hidden">
      ...
      {/* Variants section */}
      <section className="mt-6 mb-10 rounded-xl border border-slate-200 bg-white overflow-hidden">
        <div className="bg-slate-50 border-b border-slate-200 px-6 py-3">
          <h2 className="text-sm font-semibold text-slate-700 uppercase tracking-wide">
            Variants
            <span className="ml-2 font-normal text-slate-400 text-xs normal-case">
